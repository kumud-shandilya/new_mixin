...
const (
	mixinName    = "FabricMixin"
	mixinPackage = "github.com/getporter/FabricMixin"
...
func Publish() {
	...
	if _, overridden := os.LookupEnv(releases.ReleaseRepository); !overridden {
		os.Setenv(releases.ReleaseRepository, "github.com/Kumud/YOURREPO")
	}
	...
	//	os.Setenv("PORTER_PACKAGES_REMOTE", "git@github.com:Kumud/YOUR_PACKAGES_REPOSITORY")
	//}
